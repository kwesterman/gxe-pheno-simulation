...
write_csv(select(gxe_effects_df, rsID), "../data/processed/simulation/sung2018_variants.csv")
write_csv(gxe_effects_df, "../data/processed/simulation/sung2018_effects.csv")
